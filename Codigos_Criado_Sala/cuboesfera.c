//de forma a exibir o cubo de forma mais legivel, como uma matriz 3D
...
int main(){
	int profundidade = 15, altura = 15, largura = 15;
	int ***cubo;
	cubo = preencherCubo(profundidade, altura, largura);
	mostrarCubo(largura, altura, profundidade, cubo);
	return 0;
}